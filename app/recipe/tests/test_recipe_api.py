...
class PrivateRecipeApiTests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email='user@exmample.com', password='testpass123')
    ...
    def test_recipe_limited_to_user(self):
        """Test list of recipes is limited to authenticadted user."""
    ...
    def test_create_tag_on_update_with_existing_tag(self):
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('4.30'),
            'ingredients': [{'name': 'Chicken'}, {'name': 'Masala'}],
        }
        response = self.client.post(RECIPES_URL, payload, format='json')
